...
class StudentView(APIView):
    ...
    def post(self, request):
        ...
        if 'guardian_1_image' not in request.FILES:
            student_details['guardian_1_image'] = "http://89.116.122.234/placeholder/avatar-01.jpeg"
        else:
            student_details['guardian_1_image']="path"
            
        if 'guardian_2_name' in request.POST:
            if 'guardian_2_image' not in request.FILES:
                student_details['guardian_2_image'] = "http://89.116.122.234/placeholder/avatar-01.jpeg"
            else:
